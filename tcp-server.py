...
#
from calculator_common import SupportedFunction, CalculatorServiceTCP, addition, subtraction, multiplication, division
...
calculator_svc = CalculatorServiceTCP('0.0.0.0', 10000, FUNCTION_MAP)
